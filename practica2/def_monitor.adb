...
package body def_monitor is
     protected body Monitor is
          ...
          -- entry que solo deja pasar las tareas que cumplen con la variable condicional
          ...
          -- devuelve el salon en el que se añade a la persona y actualiza la variable de condición
          ...
          -- inicializa los variables para el correcto funcionamiento del objeto protegido
